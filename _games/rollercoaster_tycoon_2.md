...
After the imports are restored, SecuROM is defeated :) There is actually one last disc check which is easily defeated by altering an entry in the registry, but I'll leave that to you to figure out. Just make sure to rename the cracked/dumped game.exe back to _rct2.exe_.<br><br>
